...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      <img src={logo} alt='APPMATIX' className='w-[144px] h-[90px]'/>
      <h1 className='flex-1 font-roboto font-bold ss:text-[62px] text-[42px] text-white ss:leading-[100.8px] leading-[75px]'>
      
      <span className='text-gradient'>APPMATIX</span>  
